...
```bash
jack@github:~$ ./whoami.sh

> Role:     Security Engineer & Advisor
> Work:     Orange Cyberdefense
...
After graduating, I began working as a Cybersecurity Consultant, which provided a crash course in the modern professional landscape. I was frequently challenged with unfamiliar subjects, which accelerated my learning curve. Later, I took on the role of IT Security Manager at a hospital. This role gave me a vital perspective on infrastructure; working in healthcare was particularly impactful, as security decisions directly influenced patient safety and health outcomes.
...
My Homelab Setup:
- Networking: Unifi gear
- Server: Intel NUC8i3BEH running Proxmox
- Virtualization: A mix of LXCs and a VM-based Docker host
- Connectivity: Tailscale (for secure and reliable interconnection)
...
[![Packer](https://img.shields.io/badge/Packer-02A8EF?logo=packer&logoColor=fff)](#)
...
[![Synology](https://img.shields.io/badge/Synology-0067E6?logo=synology&logoColor=fff)](#)


### Networking
[![Tailscale](https://img.shields.io/badge/Tailscale-cccccc?logo=tailscale&logoColor=fff)](#)
[![Ubiquiti](https://img.shields.io/badge/Ubiquiti-0140A8?logo=ubiquiti&logoColor=fff)](#)
